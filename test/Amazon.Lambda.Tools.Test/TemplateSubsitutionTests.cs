...
namespace Amazon.Lambda.Tools.Test
{
    public class TemplateSubsitutionTests
    {
        ...
        public void SubstituteStateMachine()
        {
            ...
            var newTemplateBody = LambdaUtilities.ProcessTemplateSubstitions(null, templateBody, substitutions, fullPath);
        ...
        public void SubstituteObject()
        {
            ...
            var newTemplateBody = LambdaUtilities.ProcessTemplateSubstitions(null, templateBody, substitutions, null);

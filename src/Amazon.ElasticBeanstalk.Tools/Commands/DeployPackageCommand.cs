...
{
    public class DeployPackageCommand : EBBaseCommand
    {
        public const string COMMAND_NAME = "deploy-package";
        public const string COMMAND_DESCRIPTION = "Deploy a packaged application to an AWS Elastic Beanstalk environment.";
        ...
        public DeployPackageCommand(IToolLogger logger, string workingDirectory, string[] args)
